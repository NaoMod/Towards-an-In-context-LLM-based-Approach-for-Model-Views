    ...
    "items": [
        {
            ...
            'template': """You specialize in reason on PlantUML metamodels, especially combining and merging them.
                        ...
                        Always define and use the same metamodel identifier for each metamodel.
                        ...
                        1. For the first PlantUML metamodel, create the metamodel identifier and identify all the classes.
                        2. For the second PlantUML metamodel, create the metamodel identifier and identify all the classes.
