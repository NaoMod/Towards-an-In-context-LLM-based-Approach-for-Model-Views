...
with open(CSV_FILE, mode='w', newline='') as csv_file:
    ...
    writer1.writerow(['user_input', 'meta_1', 'meta_2', 'relations', 'combinations'])
    i=0
            ...
            for file in os.listdir(plant_uml_folder):
                if file.endswith(".txt"):
                    ...
                    if len(plant_uml_files) == 2:
                        ...
                        writer1.writerow([user_input, f"'{plantuml1_content}'", f"'{plantuml2_content}'",relations[i-1], "[]"])
