...
from core.vpdl_where_chain import execute_chain
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        ...
        print("Usage: python -m cli.inner.where <view_name> <prompt_type> <relations>. Assuming default values: Book_Publication, baseline, book_publications_relations")
    ...
    config = Config("SLE-Presentation-Where")
    config.load_keys()
    llm = config.get_llm()
